...
- 标签云和基础 Dashboard。
- Star DNA 技术画像。
- Hidden Gems / 隐藏宝石 和 Sleep Stars / 沉睡星标。
- README 摘要。
...
- `星标仓库` 页展示开发者全部 Star 仓库的整体分析，包括 8 个顶部信息块：`Star 仓库概览`、`最近同步`、`自动标签覆盖`、`Hidden Gems / 隐藏宝石`、`Sleep Stars / 沉睡星标`、`活跃仓库`、`Removed Stars`、`License 风险`。
...
- 当前 Demo 中的双语标签是过渡展示；接入多语言后，中文模式显示中文，英文模式显示英文，不再依赖混排标题。
